...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		lblTitulo.setBounds(530, 55, 310, 42);
		...
		txtNreserva.setText(String.valueOf(huespedController.getReservaActual()));
...
////		
		...
		JPanel btnReservar = new JPanel();
		btnReservar.setBounds(723, 560, 122, 35);
		...
		btnReservar.setBackground(new Color(12, 138, 199));
		...
		lblReservar.setFont(new Font("Roboto", Font.PLAIN, 18));
		lblReservar.setBounds(0, 0, 122, 35);
	...
	public void guardar() {
		if (txtNombre.getText().isEmpty() || txtApellido.getText().isEmpty() || txtFechaN.getDate().equals(null)
				|| txtNacionalidad.getSelectedItem().equals("") || txtNreserva.getText().isEmpty()
